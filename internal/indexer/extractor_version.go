...
var extractorVersions = map[string]int{
	...
	"csharp": 20,                                     // case-label and when-guard pattern variables scope to their switch section (was: accessor bodies, property/field initializers, and the typed value parameter own their calls)
