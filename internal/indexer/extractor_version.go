...
var extractorVersions = map[string]int{
	...
	"csharp": 19,                                     // repeated partial base classes dropped, chained/awaited receivers typed at the site offset (was: accessor bodies, property/field initializers, and the typed value parameter own their calls)
