...
var extractorVersions = map[string]int{
	...
	"csharp": 19,                                     // case-label and when-guard pattern variables scope to their switch section (was: accessor bodies, property/field initializers, and the typed value parameter own their calls)
