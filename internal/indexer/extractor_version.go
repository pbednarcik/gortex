...
var extractorVersions = map[string]int{
	...
	"csharp": 20,                                     // partial / conditionally-compiled properties carry their recorded ownership span (was: verbatim-identifier canonicalization unified across type refs, the base-list prescan, and partial identity)
